            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="alumnosvw.php">Alumnos
                    ...
                    <div class="card-body p-2">
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" class="form-control" placeholder="Ingresa nombre del alumno" id="nombreinput" value="<?php if (isset($aDatosSeleccionado)) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido" class="form-control" placeholder="Ingresa apellido del alumno" id="apellidoinput" value="<?php if (isset($aDatosSeleccionado)) {
